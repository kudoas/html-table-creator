...
const Component: React.FCX = React.memo(({ className }) => {
  console.log('footer');
  return (
    <footer className={className}>
      ...
      <ul>
        ...
        <li>
          <a href="https://github.com/Kudoas/html-table-creator" target="_blank">
            GitHub <i className="fab fa-github"></i>
          </a>
        </li>
        <li>
          <a href="https://developer.mozilla.org/ja/docs/Web/HTML/Element/table" target="_blank">
            What is &lt;table&gt;?
          </a>
        </li>
      </ul>
